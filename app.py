...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Huế - Trường Tiểu học Minh Quang - ĐT: 0338 385 488</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Huế - Trường Trường Tiểu học Minh Quang - ĐT: 0338 385 488</div>", unsafe_allow_html=True)
